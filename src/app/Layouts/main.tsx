...
export const DashboardSidebar = ({
  ...
  const getSidebarLinkClasses = (path: string) => {
    ...
    if (isActive) {
      return `flex items-center ${isCollapsed ? "p-2 justify-center text-center" : "px-4 py-3"} z-20 text-sm font-medium rounded-xl transition-all duration-300 ${
        darkMode
    ...
    return `flex items-center ${isCollapsed ? "p-2 justify-center text-center" : "px-4 py-3"} z-20 text-sm font-medium rounded-xl transition-all duration-300 ${
      darkMode ? "text-gray-300 hover:bg-gray-700 hover:text-white" : "text-primary/70 hover:bg-primary/5"
    }`;
  };
  ...
  return (
    <aside
      className={`fixed left top-20 bottom-4 rounded-2xl shadow-xl transform transition-all duration-500 ease-in-out ${hiddenSide ? "-z-10" : "z-10"} ${
    ...
    >
      <button
        ...
        className={`absolute -right-3 top-1/2 z-40 p-2 rounded-full transition-all duration-300 ${
          darkMode ? "bg-gray-700 text-white hover:bg-gray-600 shadow-lg" : "bg-white text-gray-700 hover:bg-gray-100 shadow-lg border border-gray-200"
        }`}
  ...
  const getLinkClasses = (path: string) => {
    ...
    if (isActive) {
      return `lg:inline-block text-md font-medium px-4 py-2 rounded-lg transition-colors duration-300 ${
        darkMode ? "bg-gray-800 text-gray-100" : "bg-primary/5 text-gray-900"
      }`;
    }
    return `lg:inline-block text-md font-medium px-4 py-2 rounded-lg transition-colors duration-300 ${
      darkMode ? "text-gray-100 hover:bg-gray-700" : "text-gray-900 hover:bg-gray-200"
    }`;
  };
  ...
  return (
    <div className={`min-h-screen flex flex-col top-0 w-full ${overflow}`}>
      ...
      <div className="flex w-full h-full">
        ...
        <div
          className={`fixed left-0 top-16 w-64 transform transition-transform duration-200 ease-in-out z-20 lg:hidden ${
        ...
        <main
          className={`flex w-full transition-all duration-500 ${typeFixed ? "fixed" : "overflow-y-auto"} right-0 min-h-screen h-full pt-16 pb-4 ${
