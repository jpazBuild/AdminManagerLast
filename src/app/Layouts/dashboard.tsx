                ...
                <div className="flex flex-col justify-between h-full">
                    <div>
                        ...
                        <nav className="space-y-4">
                            <Link
                                href={"/"}
                                className={`w-full flex items-center px-4 py-2 text-lg rounded-md transition-colors duration-300 ${darkMode ? "hover:bg-gray-700" : "hover:bg-[#021d3d]/10 text-gray-800"}`}
                            >
