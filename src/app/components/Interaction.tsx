    ...
    return (
        <div className="mb-2">
            <button
                ...
                className="border-l-4 border-[#021d3d] flex w-full items-center p-2   justify-between font-semibold rounded-md gap-2"
            >
                    ...
                    {selectors && selectors.length > 0 && (
                        <>
                            <div
                                ...
                                className={`shadow-md py-2 px-4 flex justify-between items-center cursor-pointer rounded-md transition-all duration-300 ${isSelectorsExpanded ? "rounded-b-none border-l-4 border-[#021d3d]" : "rounded-md"
                                    }`}
                            >
                    ...
                    {attributes && Object.keys(attributes).length > 0 && (
                        <>
                            <div
                                ...
                                className={`shadow-md py-2 px-4 flex justify-between items-center cursor-pointer rounded-md transition-all duration-300 ${isAttributesExpanded ? "rounded-b-none border-l-4 border-[#021d3d]" : "rounded-md"
                                    }`}
                            >
...
const InteractionItem = ({ data, index }: InteractionItemProps) => {
    return (
        <div key={data.id} data-index={index} className="flex flex-col gap-4">
            <div className="flex flex-col gap-2 py-2 px-2  rounded-md border-l-4 border-[#021d3d] shadow-lg transition-all duration-300">
